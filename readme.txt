...
This is shared for immediate access and view of the assignment. Else, the use of visual studio supports the .ipynb format for the document attached.

The machine learning model is saved as a pickle file in the lab folder.

The code is included in the .py and .ipynb submitted.